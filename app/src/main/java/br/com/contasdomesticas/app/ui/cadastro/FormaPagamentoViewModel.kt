...
import br.com.contasdomesticas.app.data.repository.FormaPagamentoRepository
import dagger.hilt.android.lifecycle.HiltViewModel
import kotlinx.coroutines.launch
import javax.inject.Inject

data class FormaPagamentoUiState(
    val itens: List<FormaPagamentoDto> = emptyList(),
...
class FormaPagamentoViewModel @Inject constructor(
    ...
    var estado by mutableStateOf(FormaPagamentoUiState())
        private set
    ...
    fun criar(request: FormaPagamentoRequestDto) {
        viewModelScope.launch {
